...
config :test_app, TestAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "fWmUgMHt59P9l6/KWDWhg2Y9sgYwrTUHVn3Pi0PmmrhFoA5uympJmmc6k4csIxW/",
  watchers: [
...
config :test_app, TestAppWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/test_app_web/router\.ex$"E,
      ~r"lib/test_app_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
